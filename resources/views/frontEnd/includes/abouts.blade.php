    ...
    <div class="container">
      <div class="inner-sec-w3ls-agileits py-lg-5 py-3">
        <div class="header-info about-in mt-5 pb-5 text-center">
          <h3 class="heading">About Pro Studio</h3>
          <p class="para mt-4"> We are Pro Studio. From now you can easily hire your favrioute photographers. All kind of phottographers are here. </p>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <img src="{{asset('frontEnd/')}}/img/anika.jpeg" class="img-fluid" alt="">
